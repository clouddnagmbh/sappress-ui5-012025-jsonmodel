		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atclouddnajsonmodelexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnajsonmodelexample-display": {
								"semanticObject": "atclouddnajsonmodelexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.jsonmodelexample",
									"url": sap.ui.require.toUrl("at/clouddna/jsonmodelexample")
								}
							}
						}
					}
